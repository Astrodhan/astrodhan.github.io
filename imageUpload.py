...
images_folder = "/home/yashodhan/Documents/website/astrodhan.github.io/images/photography"

# Path to your gallery HTML file
gallery_html_file = "/home/yashodhan/Documents/website/astrodhan.github.io/dirart/photo.html"
...
for i in range(0,int(numberOfImages/4)+1):
    ...
    for j in [0,1,2,3]:
        if 4*i+j<numberOfImages:
            ...
            img = soup.new_tag('img', src=f'../images/photography/{images[4*i+j]}', alt=images[4*i+j], width="400")
            cell.append(img)
            row.append(cell)
    table.append(row)
